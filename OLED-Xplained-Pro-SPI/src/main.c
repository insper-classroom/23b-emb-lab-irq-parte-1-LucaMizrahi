...
volatile char time_stop;
volatile char time_start;
...
void io_init(void)
{
	...
	// Configura PIO para lidar com o pino do bot?o 1 como entrada
	// com pull-up
	...
	// Configura PIO para lidar com o pino do bot?o 2 como entrada
	// com pull-up
...
int main (void)
{
	...
	while(1) {
		...
		//if(but_flag1){
			//delay_ms(1);
			//if (tempo <= 1000 && time_stop == 1){
				//frequencia_default -= 100;
				//time_stop = 0;
				//time_start = 0;
				//but_flag1 = 0;
				//tempo = 0;
			//} else if(tempo >= 1000 && time_stop == 1){
				//frequencia_default += 100;
				//time_stop = 0;
				//time_start = 0;
				//but_flag1 = 0;
